...
(custom-set-variables
 ...
 '(package-selected-packages
   '(goto-last-change company-restclient blacken git-gutter use-package pyenv-mode sr-speedbar academic-phrases exec-path-from-shell jedi nyan-mode web-mode smart-mode-line py-autopep8 markdown-preview-mode magit json-mode js2-mode hc-zenburn-theme flycheck elpy better-defaults)))
(custom-set-faces
